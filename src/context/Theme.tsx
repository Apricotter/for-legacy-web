...
export const PRESETS: Record<string, Theme> = {
    light: {
        ...
        block: "#5C3D11",
        "message-box": "#F5F0EB",
        mention: "rgba(201, 123, 46, 0.15)",
        success: "#65E572",
        warning: "#FAA352",
        tooltip: "#FFF",
        error: "#ED4245",
        hover: "rgba(0, 0, 0, 0.06)",
        "scrollbar-thumb": "#E89A3F",
        "scrollbar-track": "transparent",
        "primary-background": "#FEF3E2",
        "primary-header": "#F5F5F5",
        "secondary-background": "#F5F5F5",
        "secondary-foreground": "#4A4A4A",
        "secondary-header": "#EFEFEF",
        "tertiary-background": "#E8E8E8",
        "tertiary-foreground": "#6B6B6B",
        css: "--sidebar-active: var(--secondary-background);",
